        ...
        <div class="image-container">
          ...
          <div class="image-overlay">
            <div class="image-actions">
              <el-button size="small" type="primary" @click.stop="downloadImage(image)">
          ...
          <div class="status-badge">
            <el-tag :type="getStatusColor(image.status)" size="small">
              {{ image.status }}
            </el-tag>
          </div>
          ...
          <div v-if="image.qualityScore" class="quality-score">
            <el-tag :type="getQualityColor(image.qualityScore)" size="small">
              {{ image.qualityScore }}%
            </el-tag>
          </div>
        </div>
        ...
        <div class="lightbox-info">
          <el-descriptions :column="2" border>
            ...
            <el-descriptions-item label="Status">
              <el-tag :type="getStatusColor(selectedImage.status)">
          ...
          <div class="lightbox-actions">
            <el-button type="primary" @click="downloadImage(selectedImage)">
              <el-icon><Download /></el-icon>
              Download
            </el-button>
            <el-button type="success" @click="processSelectedImage">
...
const processSelectedImage = async () => {
  ...
  try {
    ElMessage.info('Processing image...')
